...
CREATE TABLE IF NOT EXISTS `3xAdvisor`.`category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `3xAdvisor`.`advice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `3xAdvisor`.`photo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `place_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `3xAdvisor`.`favorite` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `place_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `3xAdvisor`.`hobbies_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
ALTER TABLE `3xAdvisor`.`favorite`
...
--
ALTER TABLE `3xAdvisor`.`hobbies_list`
