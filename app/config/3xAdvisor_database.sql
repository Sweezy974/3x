...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 15 avr. 2018 à 19:23
...
CREATE TABLE IF NOT EXISTS `city` (
  ...
  UNIQUE KEY `UNIQ_2D5B0234550C01C2` (`zipcode`)
...
INSERT INTO `city` (`id`, `name`, `zipcode`, `area`) VALUES
...
CREATE TABLE IF NOT EXISTS `place` (
  ...
  `bestPicture` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'default.jpg',
  `date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `main_photo` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'default.jpg',
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `place_advices`;
CREATE TABLE IF NOT EXISTS `place_advices` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `IDX_BCAFA563DA6A219` (`place_id`),
  KEY `IDX_BCAFA563A76ED395` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `place_advices` (`id`, `place_id`, `user_id`, `title`, `comment`, `score`, `date`) VALUES
...
(6, 6, 1, 'parcours assez difficile', 'Aliquam sit amet felis facilisis urna eleifend ullamcorper ac nec risus. Morbi sodales diam eget eleifend pharetra. Pellentesque faucibus nisi gravida ex ultricies pretium quis vitae nunc. Morbi odio ante, ornare at porttitor sagittis, semper sed nisi. Nu', 2, '2018-04-15 19:02:25');
...
DROP TABLE IF EXISTS `place_advices_photos`;
CREATE TABLE IF NOT EXISTS `place_advices_photos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
  `place_id` int(11) DEFAULT NULL,
  `advice_id` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'default.jpg',
  `date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `IDX_A719281AA76ED395` (`user_id`),
  KEY `IDX_A719281ADA6A219` (`place_id`),
  KEY `IDX_A719281A12998205` (`advice_id`)
...
CREATE TABLE IF NOT EXISTS `place_categories` (
  ...
  `name` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_1433D0605E237E06` (`name`)
...
INSERT INTO `place_categories` (`id`, `name`) VALUES
(12, 'CULTURE'),
(11, 'DÉCOUVERTE'),
(3, 'DIVERTISSEMENT'),
(1, 'NATURE'),
...
INSERT INTO `user` (`id`, `city_id`, `username`, `username_canonical`, `email`, `email_canonical`, `enabled`, `salt`, `password`, `last_login`, `confirmation_token`, `password_requested_at`, `roles`, `description`, `age`, `avatar`, `avatar_updated_at`) VALUES
(1, 1, 'user974', 'user974', 'user@test.fr', 'user@test.fr', 1, NULL, '$2y$13$cSIuTklm56v5f/TjbaEhROPvh.iBy11.gTrbhlJRQW1JbHAVcxhui', '2018-04-15 17:37:00', NULL, NULL, 'a:0:{}', 'Bonjour, je suis un simple utilisateur !', '1983-04-06', 'default-user-img.png', '2018-04-15 17:37:00');
...
CREATE TABLE IF NOT EXISTS `user_favorites` (
  ...
  KEY `IDX_E489ED11DA6A219` (`place_id`)
...
INSERT INTO `user_favorites` (`id`, `user_id`, `place_id`) VALUES
(2, 1, 4);
...
CREATE TABLE IF NOT EXISTS `user_hobbies` (
  ...
  `user_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_60C72A178CB39020` (`first_category_id`),
  KEY `IDX_60C72A177BA301FC` (`second_category_id`),
  KEY `IDX_60C72A1752287616` (`third_category_id`),
...
INSERT INTO `user_hobbies` (`id`, `first_category_id`, `second_category_id`, `third_category_id`, `user_id`) VALUES
(1, 1, 3, 10, 1);
...
--
ALTER TABLE `place`
  ADD CONSTRAINT `FK_741D53CD12469DE2` FOREIGN KEY (`category_id`) REFERENCES `place_categories` (`id`),
...
--
ALTER TABLE `place_advices`
  ADD CONSTRAINT `FK_BCAFA563A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `FK_BCAFA563DA6A219` FOREIGN KEY (`place_id`) REFERENCES `place` (`id`);

--
-- Contraintes pour la table `place_advices_photos`
--
ALTER TABLE `place_advices_photos`
  ADD CONSTRAINT `FK_A719281A12998205` FOREIGN KEY (`advice_id`) REFERENCES `place_advices` (`id`),
  ADD CONSTRAINT `FK_A719281AA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `FK_A719281ADA6A219` FOREIGN KEY (`place_id`) REFERENCES `place` (`id`);
...
ALTER TABLE `user_favorites`
  ADD CONSTRAINT `FK_E489ED11A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `FK_E489ED11DA6A219` FOREIGN KEY (`place_id`) REFERENCES `place` (`id`);

--
-- Contraintes pour la table `user_hobbies`
--
ALTER TABLE `user_hobbies`
  ADD CONSTRAINT `FK_60C72A1752287616` FOREIGN KEY (`third_category_id`) REFERENCES `place_categories` (`id`),
  ADD CONSTRAINT `FK_60C72A177BA301FC` FOREIGN KEY (`second_category_id`) REFERENCES `place_categories` (`id`),
  ADD CONSTRAINT `FK_60C72A178CB39020` FOREIGN KEY (`first_category_id`) REFERENCES `place_categories` (`id`),
  ADD CONSTRAINT `FK_60C72A17A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
COMMIT;
